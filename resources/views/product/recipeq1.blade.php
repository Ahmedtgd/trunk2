<table class="table table-bordered" id="q1-table" width="100%">
    <thead style="background-color: #e46c0a;color:#fff">
        <tr role="row">
            ...
            <th class="text-center" style="width:170px">Measurement</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center" style="vertical-align: middle">{{$product->npid}}</td>
            <td class="text-left" style="vertical-align: middle"><img style="object-fit:cover;" width="30"  height="30" src="{{url()}}/images/product/{{$product->id}}/thumb/{{$product->thumb_photo}}">&nbsp;{{$product->name}}</td>
            <td class="text-center" style="vertical-align: middle;width:170px" >
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.error == true)
                    {
                        ...
                        $span.text('');
                        unitChanged(data.product_id,data.uom_id);
                    }
                },
                error: function(data) {
                    $span.text('Error updating');
