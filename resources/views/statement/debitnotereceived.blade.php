...
<span style="font-size:14px !important;"
     ...
     <div id="" class="tab-content">
         <div id="sell" class="tab-pane fade in active">
            <table class="table-bordered"  id="sellTablerecevied" width="100%">
                ...
                <?php
                    ...
                    <td class="text-center"><a href="/view_debit_notes/{{$order->id}}?dealer_id={{$order->dealer_user_id}}" class="view_debit_notes" >{{sprintf('%010d', $order->debitnote_no)}}</td>
...
$(document).ready(function () {
	...
	$("#buy").show();
	$('#sellTablerecevied').dataTable().fnDestroy();
	$('#sellTablerecevied').DataTable({
	"order": [],
	"columnDefs": [ {
	"targets" : 0,
	"orderable": false
