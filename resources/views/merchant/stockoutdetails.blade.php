...
<div class="container " >
        ...
        <div class="col-md-12" style="padding:0" >
            ...
            <div class="row">
                ...
                <div class="col-md-6"
                    ...
                    <div class="col-md-1"
                         style="display:inline;margin-left:-210px;margin-bottom:20px;margin-top:25px;">To&nbsp;&nbsp;</div>
                    <div class="col-md-3"
                         style="right:200px;display:inline;margin-left:12px;
					margin-bottom:20px">
                        <input
                                class="form-control"
                                style="margin-top:21px;padding-top:6px !important"
                    ...
                    <div id="mybutt" class="col-md-1 text-right"
                         style="padding:0;">
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            if(since == "since" && ytd != "ytd" && mtd != 'mtd' &&
                    wtd != 'wtd' && daily != 'daily' && hourly != 'hourly') {
                fetch_products_code()

            } else if(ytd == "ytd" && since != "since" && mtd != 'mtd' &&
                    wtd != 'wtd' && daily != 'daily' && hourly != 'hourly') {
                fetch_products_code()

            } else if(mtd == 'mtd' && ytd != "ytd" && since != "since" &&
                    wtd != 'wtd' && daily != 'daily' && hourly != 'hourly' ) {
                fetch_products_code()

            } else if(wtd == 'wtd' && mtd != 'mtd' && ytd != "ytd" &&
                    since != "since" && daily != 'daily' && hourly != 'hourly'  ) {
                fetch_products_code()

            } else if(daily == 'daily' && wtd == 'wtd' && mtd != 'mtd' &&
                    ytd != "ytd" && since != "since" && hourly != 'hourly'  ) {
                fetch_products_code()
            }
        ...
        function fetch_products_code(message = null,TimeFilter = null) {
            ...
            $.ajax({
                type: "GET",
                url: "{{URL('/merchant/stockoutsince')}}",
                data: {
                    fromDate: fromDate,
                    toDate: toDate,
                    toDate: toDate,
		...
		`;
            ...
            if(listproducts == 0){
                ...
                jQuery.each( listproducts, function( key, listproducts ) {
                    ...
                    //   } else {
                    bar2 = parseInt(listproducts.sales1);
                    bar = 80/k*bar2;
                    //  }
            ...
            $('#skutbl').DataTable({
                ...
                buttons: [{
                    ...
                    customize: function(doc) {
                       ...
                       /* doc['content'][0] = [{
                        ...
                        /* Datatable Header, "Sales" Column */
                        doc['content'][1].table.body[0][2].text = 'Sales (MYR)';
                ...
                initComplete: function(settings, json) {
                    ...
                    $('.dt-button').attr('style','width:70px;height:70px;border-radius:5px;padding-left:4px;background:skyblue;border-color:skyblue;color:white;margin-right:0;border-width:0;position:relative;left:200px');
                }
            });
        ...
        function fetch_products_for_today(date) {
            ...
            if ((from.length < 1) || (from == "Select Date")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{URL('merchant/stockout_range')}}",
