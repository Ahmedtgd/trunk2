                ...
                @if(isset($deliveryorder))
                        ...
                        <div class="col-sm-12">
                            ...
                            <table class="table">
                                ...
                                // $tproducts = DB::table('orderproduct')->where('porder_id',$deliveryorderid)->get();
                                $tproducts = DB::table('orderproduct')
                                ->leftjoin('nproductid','nproductid.product_id','=','orderproduct.product_id')
                                ->where('orderproduct.porder_id',$deliveryorderid)->get();
                                ...
                                @if(isset($tproducts))
                                    @foreach($tproducts as $product)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $product->nproduct_id }}</td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td class="pull-left" colspan='2'>Delivery</td>
                                            <td></td>
                                            <td></td>

                                            <td class="pull-right" colspan="2">{{$currency}}
                                    ...
                                    <tr style="border-bottom: 1px solid #ddd;border-top: 1px solid #ddd;">
                                        ...
                                        ?>
                                        <td  >
                                            <b class="pull-right">Total&nbsp;{{$currency}}&nbsp;{{number_format($sum_amount/100,2) }}
                                            </b>
										</td>
										<td width="20px">
										</td>
