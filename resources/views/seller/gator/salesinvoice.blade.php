                            ...
                            @if(isset($tproducts))
                                ...
                                @foreach($tproducts as $tproduct)
                                        <tr>
                                            ...
                                            // $prime_product = DB::table('opos_receiptproduct')->where('receipt_id',$tproduct->tproduct_id)->first();
                                            ...
                                            <td class="text-center">{{ $tproduct->id }}</td>


                                            <td colspan="2">{{ $product_name->name }}</td>
                                            <?php
                                            ...
                                            <td class="text-right">
                                                {{$currency->code}} {{number_format($opc/100,2)}}
                                            </td>
                                            <td class="text-right">{{$currency->code}} {{ $amount }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td class="pull-right">{{$currency->code}} {{number_format(20 /100,2)}}</td>
                                        </tr>
                                @endforeach
                                <tr>
                                ...
                                <tr style="border-bottom: 1px solid #ddd;border-top: 1px solid #ddd;">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <b>Total&nbsp;{{$currency->code}}&nbsp;{{ number_format($sum_amount/100,2) }}
                                        </b></td>
                                </tr>
                            @endif
