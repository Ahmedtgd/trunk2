		...
		<div class="col-md-12">
			...
			<div class="row" style="display:flex;align-items:flex-end">
				...
				@if($InvoiceDisplayData['array_delivery'][0]['line3'])
					...
					<br>
				@endif
					@if($InvoiceDisplayData['array_delivery'][0]['postcode'])
						{{$InvoiceDisplayData['array_delivery'][0]['postcode']}}
						<br>
					@endif
					@if($InvoiceDisplayData['array_delivery'][0]['city'])
						{{$InvoiceDisplayData['array_delivery'][0]['city']}} , {{$InvoiceDisplayData['array_delivery'][0]['state']}}
						<br>
					@endif
				...
				{{$InvoiceDisplayData['CompanyName']->company_name}}
				</b><br>
				@if($InvoiceDisplayData['array_delivery'][0]['merchant_bizregno'])
				<span>
				({{$InvoiceDisplayData['array_delivery'][0]['merchant_bizregno']}})
				</span><br>
				@endif
				@if($InvoiceDisplayData['array_delivery'][0]['mline1'] != "")
					<span>
					{{$InvoiceDisplayData['array_delivery'][0]['mline1']}}
					</span><br>
				@endif

				@if($InvoiceDisplayData['array_delivery'][0]['mline2'] != "")
					<span>
					{{$InvoiceDisplayData['array_delivery'][0]['mline2']}}
					</span><br>
				@endif

				@if($InvoiceDisplayData['array_delivery'][0]['mline3'] != "")
				   <span>
				   {{$InvoiceDisplayData['array_delivery'][0]['mline3']}}
				   </span>
				@endif
