    ...
    .hide {display:none}
               ...
               ?>
                    <table style="margin-left: 26px;margin-top: 5px;">
                     <tr>
                        ...
                        <td>
                            : <span id="">{{sprintf('%010d', $merchant->salesorder_no )}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left">
                    ...
                    <tr>
                        ...
                        <td>
                            : <span id="">{{$merchant->memberfirst}} {{$merchant->memberlast}}</span>
                        </td>
                    </tr>
                    @endif
                    @if($merchant->deliverymanId != '')
                    ...
                    <ul class="diff_message">
                         @foreach($invoice as $singleinvoice)
                            ...
                            // print_r($invoice);
                            // exit();
                            if($singleinvoice['approved_qty'] > 0){
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $('.qrcodedp').qrcode({height:70,width:70,text: <?php if($merchant) {echo sprintf('%060d', $merchant->salesorder_no);  }else{ echo "00000000000000000";} ?> });
