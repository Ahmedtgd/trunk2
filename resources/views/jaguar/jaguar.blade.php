...
<script type="text/javascript">
    ...
    <div class="blur">
        ...
        <input hidden="" id="" type="text" value="{{$user_id}}" name="user_id">
    		...
    		<div class="table-responsive" style="margin-bottom: 28px;"></div>
    		...
    		<div  class="container">
    			...
    			<div style="float: right;color: white;padding-top:28px" type="button" id="stationbtn" class="bg-black sellerbutton" onclick="gatorBuyer()">Merchant</div>

    			<h2 style=" width: 40%;float: left; padding-top: 5px;">Procurement: Purchase Order</h2>
    			<div>
					<h4 class="text-center" style="color:#3c24ff;width:30%;height:60px;float:left;padding-top: 15px;" id="showselectedbuyer"></h4>
				</div>
    				...
    				<div id="maingatortable" >
    					<div class="container">
    						<table id="gatortable" class="table table-bordered">
								<thead class="bg-jaguar" style="width:100%;font-weight:bold">
									<tr>
										...
										<td style="width: 20% !important;" class='text-center bmedium'>Qty</td>
										<td style="width: 15%;" class='text-center bmedium'>Total ({{$currentCurrency}})</td>
									</tr>
								</thead>
								<tbody>
								</tbody>
