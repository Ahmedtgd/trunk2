...
$logo_url="http://mpstele.my/images/MPS-Logo.png";
$home_url="http://mpstele.my";
$width="151px";
$ref = "opensupermall.com";
/*try {
	$ref=$_SERVER['HTTP_REFERER'];
	Session::set('mode','onz');
} catch (\Exception $e) {
...
if (empty($mode) || $mode=="osm") {
	# code...
	$mode="osm";
	$logo_url=asset('images/logo-white.png');
	$width="400px";
	$height="95px";
	$home_url=route("home");
}
...
.nohover:hover{background: #000000 !important; cursor: auto;}
    ...
    <div class="mobile-header" style="font-size:13px !important;" style="background-color: black; ">
		...
		<div class="dropdown-content-systemseller">
			...
			<div class="row" style="margin-right: 5px !important; margin-left: 5px !important;">
				<div class="col-xs-6" style="border: 1px solid #73D2C6;">
					<h3 align="center" style="color: {{$mcolor}}">Merchant</h3></div>
				<div class="col-xs-6" style="border: 1px solid #73D2C6;">
					<h3 align="center" style="color: {{$scolor}}">Station</h3></div>
			</div>
			<br>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Account&nbsp;Information</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Sales&nbsp;Orders</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Member&nbsp;List</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Likes</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">OpenWish</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">SMM</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Documents</a></h4>
			<h4 style="color: #73D2C6 !important; margin-left: 10px;">
				<a style="color: #73D2C6 !important;" href="#">Sales&nbsp;Report</a></h4>
		</div>
        <div class="clearfix"></div>
		<div class="dropdown-content-systembuyer">
			...
			@if(Auth::check())
				<h4 style="color: #73D2C6 !important; margin-left: 10px;">
					<a style="color: #73D2C6 !important;" href="#">Shopping</a></h4>
		...
		<div class="dropdown-content-login">
			...
			<div class="mobileloginbody" style="padding: 5px;">
				<span class="pull-right closemobilelogin"
					style="padding-right: 10px; cursor: pointer;color:#FFF  !important; font-size: 18px;">X</span>
				<h3 style='font-weight: 900; color: #FFF !important;'>Sign In</h3>
				<ol style="visibility:hidden;">
						<li>&nbsp;</li>
					</ol>
				<form  id="loginForm2" class="mobile_login_form" action="{{ URL::to('LoginUser') }}" method="post"
					...
					<div class="">
						<div class="col-xs-12 no-padding">
							<input class="form-control input-sm" style="height: 50px; font-size: 16px;" name="username"
					...
					<div class="">
						<div class="col-xs-12 no-padding">
							<input type='password' name="password"
								class="form-control input-sm" style="height: 50px; font-size: 16px;"
					...
					<div class=""
						style="color:#FFF !important; font-size: 1.3em; font-weight: regular; width: 100%;">
						<div class="col-xs-4 no-padding">
						<a href="javascript:void(0)" class="showregistermob"
						style="color: inherit;">New&nbsp;Member&nbsp;&nbsp;|
						</a></div>
						{{-- <div class="col-xs-1">|</div> --}}
						<div class="col-xs-2" >
					...
					<a href="#" style="color: inherit; color: white; margin-top:10px"
							id="signin_on_mobile" class='btn signInBtnnew'>
						Sign&nbsp;In
					</a>
				</form>

				<form  id="loginForm2reg" style="display: none;" class="mobile_reg_form" action="{{ URL::to('RegisterUser') }}" method="post"
                              data-bv-message="This value is not valid"
                              data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
                              data-bv-feedbackicons-invalid="glyphicon glyphicon-remove"
                              data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
					...
					style="color: #FFD6D6;"
					class="text-center text-danger error-msg-reg"></div>
					<div id="success-msg-reg"
					style="color: #0fff6d;"
					class="text-center text-danger success-msg-reg"></div>
					<div class="">
						<div class="col-xs-12 no-padding">
							<input class="form-control input-sm" style="height: 50px; font-size: 16px;" name="username"
								placeholder="abc@yourmail.com" type="text"
					...
					<div class="col-xs-12" style='padding-left:0;padding-right:0'>
                                        <input type='password' name="confirm_password" style="height: 50px; font-size: 16px;"
					...
					<br>
					<div class=""
						style="color:#FFF !important; font-size: 1.3em; font-weight: regular;">
						<div class="col-xs-4 no-padding">
						<a href="javascript:void(0)" class="showloginmob"
						style="color: inherit;">Login&nbsp;&nbsp;|
						</a></div>
						{{-- <div class="col-xs-1">|</div> --}}
						<div class="col-xs-4" >
						{{-- <a href="#" style="color: inherit;"
					...
					<a href="#" style="color: inherit; color: white; margin-top:10px"
							id="regin_on_mobile" class='btn signInBtnnew'>
						Register
					</a>
				</form>

				<div class="" style="margin-top:20px">
					<div class="col-xs-12 no-padding social-buttons">
						<a class="btn btn-block btn-social btn-facebook" style="height: 50px; font-size: 22px; border-radius: 5px"
				...
				<div class="" style="margin-top:10px">
					<div class="col-xs-12 no-padding"><p align="center" style="color: white; font-size: 18px">What is?</p></div>
					<div class="col-xs-3 no-padding" style='text-align: left; padding-left:0;padding-right:0'>
					</div>
					<div class="col-xs-3"
					style='text-align: center; padding-left: 0px;padding-right:0'>
						 ...
						 <p align="center"
						 style="margin-top:3px;font-size: 16px; color: white;">OpenWish</p>
					</div>
					<div class="col-xs-3"
					style='text-align: center; padding-left: 0px;padding-right:0'>
						 <a href="javascript:void(0)"
						 ...
						 style='width:55px; height:55px; border-radius: 5px;'></a>
						 <p align="center"
						 style="margin-top:3px;font-size: 16px; color: white;">SMM</p>
					</div>
					...
					<div class="col-xs-12" style='text-align: left; padding-left:0;padding-right:0'>
						<p align="center" style="color: white;">By registering you are accepting OpenSupermall's
						</p>
						<p align="center" style="color: white;">
						<a style="color:blue;" href="{{URL::to('/')}}/terms_cond" target="_blank" id="">
						   Terms & Conditions
		...
		<div class="dropdown-content-menu">
			...
			style="margin-top:5px">
				@if(!Auth::check())
					<a href="javascript:void(0);" class="loginmobile showregistermob" style="color: #73D2C6 !important; font-size: 16px;">Sign Up&nbsp;</a><span style="color: #73D2C6 !important; font-size: 16px;"><b>|</b>&nbsp;</span><a href="javascript:void(0);" class="loginmobile showloginmob" style="color: #73D2C6 !important; font-size: 16px;">Log In</a>&nbsp;<span style="color: #73D2C6 !important; font-size: 16px;"><b>|</b>&nbsp;</span><a href="javascript:void(0);" class="forgot_password" style="color: #73D2C6 !important; font-size: 16px;">Forgot Password</a>
				@else
				...
				@else
				  ...
				  style="margin-left:0px;padding-left:0px;padding-right:0px;
				  	color: #34dabb;padding-right:0;float:left;margin-right:0">
					<i class="fa fa-shopping-cart"
						style="font-size: 35px;height: 25px;">
				  <span class="badgesmobile"
				  ...
				  @if(Auth::check())
					<p style="font-size:13px !important;
						margin-top: 0px !important; padding-left:0px;">
					<strong style="color:#FFF;font-size:1em;margin-right:0px;">
					OpenCredit {{number_format($ocredit,2)}} Pts</strong></p>
				  @endif
				@endif
    ...
    <div class="logo-header container" style="margin-top:-10px;">
        ...
        <div class="">
            <div class="row">
                <div class="col-sm-4  logo-holder" style="padding-left:15px">
                ...
                @if($mode=="osm")
				 ...
				 style="margin-right: 10px;">
					...
					@if(!\Illuminate\Support\Facades\Auth::check())
						<li class="pull-right">
							<a href="#" data-toggle="modal"
								data-target="#loginModal" class="showregister">SignUp</a>
						</li>
					@endif
					<li class="pull-right">
						@if(Auth::check())
						...
						@else
							<a href="#" data-toggle="modal"
								data-target="#loginModal" class="showlogin">Login</a>
						@endif
					</li>
					...
					<div class="clearfix"></div>
					 {!! Form::open(array('route' => 'search', 'class'=>'')) !!}
					<div class="input-group input-group-sm pull-right"
						>
						<span class="input-group-btn" >
							<button type="submit" style="width: 100px !important; background-color: black; margin-right: 2px !important;
							color: #34dabb; border: solid 1px #34dabb; font-size: 16px; height: 40px; border-radius: 3px !important;" class="btn btn-default">
								Search
							</button>
						</span>
						{!! Form::text('search_key_word', null,array(
							'class'=>'form-control searchweb', 'style'=>'','placeholder'=>'')) !!}

					</div><!-- /input-group -->
				</ul>
				{!! Form::close() !!}
				@endif
				@if($mode=="onz" && Auth::check())
					 <ul class="nav navbar-nav navbar-right navClor"
				 	style="margin-right: 10px;">
				 		<a class="btn btn-default "
				 		href="{{route("onz_logout")}}"
						style="background-color:#E53411 !important; color:white;padding:5px;height:40px;width:100px;border-radius:5px;border-color:#E53411;padding-top:9px">
						LOGOUT</a>
				 	</ul>
				@endif
...
// });
   ...
   <li class="{{ $cf->set_active('owarehouselist') }} dropdown mega-dropdown hypers">
				   ...
				   <?php
						$imm = null;
						if(Auth::check()){
							$imm = DB::table('merchant')->
								where('user_id',Auth::user()->id)->first();
						}
					?>
                   @if(Auth::check() &&
				   	(Auth::user()->hasRole('mer') ||
					 Auth::user()->hasRole('sto') || !is_null($imm)))
                       ...
                       @if((!Auth::user()->hasRole('log') &&
							 ...
							 Auth::user()->hasRole('mer')  || !is_null($imm))

						   @if(Auth::user()->hasRole('mer') || !is_null($imm))
                            <li class="{{$cf->set_active('seller')}}
                                ...
                                <a style="margin-left:0;padding-left:10px;padding-right:10px"
                                href="{{URL::to('/sellermembers')}}">Seller</a></li>
							@else
								<li class="{{$cf->set_active('seller')}}
                                {{$cf->set_active('edit_merchant')}}
                                {{$cf->set_active('edit_station')}}
...
<ul>
        <?php
           ...
           @if($mode=="osm")
			...
			style="font-size: 42px;height: 42px;">
			<span class="badges"
			style="margin-left:-14px;opacity: 1;color: white;font-size: 10px;">
			{!! Cart::totalItems() !!}
...
<script>
    $(document).ready(function () {
		$('.showloginmob').on('click', function(){
			$("#loginForm2reg").hide();
			$("#loginForm2").show();
		});

		$('.showregistermob').on('click', function(){
			$("#loginForm2reg").show();
			$("#loginForm2").hide();
		});
		...
		$('#regin_on_mobile').click(function(){
