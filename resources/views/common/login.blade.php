                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 modal-inside-merchant" style="padding: 15px;">
						...
						<div class="login-content-second"
							...
							<div class="clearfix"></div>
							<div class="form-group">
								{!! Form::label('gst_vat', '* SST/GST/VAT', array('class' => 'col-sm-3 control-label')) !!}
								<div class="col-sm-4">
									{!! Form::text('gst', '', array(  'placeholder'=>'Input Your SST/GST/VAT Number', 'class' => '  form-control', 'id' => 'gstvat'))!!}
								</div>
